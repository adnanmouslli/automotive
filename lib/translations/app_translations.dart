  ...
  Map<String, Map<String, String>> get keys =>
      {
        'en': {
          ...
          'PARTITION_NET': 'Partition Net',
          'WINTER_TIRES': 'Winter Tires',
          'HUBCAPS': 'Hubcaps',
          'REAR_PARCEL_SHELF': 'Rear Parcel Shelf',
          'NAVIGATION_SYSTEM': 'Navigation System',
          'TRUNK_ROLL_COVER': 'Trunk Roll Cover',
          ...
          'COMPRESSOR_REPAIR_KIT': 'Compressor/Repair Kit',
          'TOOLS_JACK': 'Tools/Jack',
          'SECOND_SET_OF_TIRES': 'Second Set of Tires',
          ...
          "billing_same_client_desc": "Billing recipient is the same as applicant",
          "billing_name": "Name",
          "billing_phone": "Phone Number",
          "billing_email": "Email",
          "billing_address": "Address",
          "billing_name_required": "Name is required",
          "billing_phone_required": "Phone is required",
          "billing_email_required": "Email is required",
          "billing_address_required": "Address is required",

          "client_information": "Applicant Information",
          "billing_information": "Billing Information",
          "vehicle_service_info": "Vehicle and Service Information",
          "different_billing_info": "Separate Billing Information",

          "vehicle_items": "Vehicle Items",
          "select_available_items": "Select available items with the vehicle",
          "partition_net": "Partition Net",
          "winter_tires": "Winter Tires",
          "hubcaps": "Hubcaps",
          "rear_parcel_shelf": "Rear Parcel Shelf",
          ...
          "additional_pickup_info": "Additional Pickup Information",
          ...
          "order_creation_note_extended": "After creating the order, you will need to add photos, signatures, and expenses to complete the order. Make sure to fill in all required data accurately.",

          "company_name_required": "Company name is required",
          "contact_person_required": "Contact person information is required",

          "order_created_with_details": "Order created successfully with all details",
          "all_data_saved": "All data saved successfully",
          ...
          "basic_vehicle_data": "Basic Vehicle Data",
          "service_information": "Service Information",

          "vehicle_damages": "Vehicle Damages",
          "select_vehicle_damages": "Select existing vehicle damages",
          "damage_types_for": "Damage Types for {side}",
          "damage_description": "Damage Description",
          "describe_damages_for": "Describe damages on the {side}",
          "total_damages_selected": "Total damages selected: {count}",
          "clear_all": "Clear All",
          ...
          "scratch_graze": "Scratch/Graze",
          "paint_damage": "Paint Damage",
          "crack_break": "Crack/Break",
          "missing": "Missing",

          "no_damages_reported": "No damages reported",
          "vehicle_in_good_condition": "Vehicle in good condition",
          "damages": "Damages",
          "vehicle": "Vehicle",
          ...
          "html_report_saved_successfully": "Report saved successfully and ready to share",
          "html_report_ready_to_view": "Report is ready to view",
          "report_generation_failed": "Report generation failed",
          "report_generation_error_message": "Error occurred while generating report. Please try again.",
          "retry": "Retry",
          "share": "Share",
          "file_path_copied": "File path copied",
          "file_path_copied_to_clipboard": "File path copied to clipboard",
          "no_email_address": "No email address",
          "no_client_email_message": "No email address registered for this client",
          "enter_email": "Enter email",
          "enter_email_address": "Enter email address",
          "enter_email_to_send_report": "Enter email address to send report",
          "invalid_email_format": "Invalid email format",
          "continue": "Continue",
          "confirm_send_email": "Confirm email sending",
          "confirm_send_report_email": "Do you want to send HTML report for this order via email?",

          "email_report_info": "An interactive HTML report containing all order details will be sent",
          "sending_email_report": "Sending report via email...",
          "please_wait_sending": "Please wait, sending...",
          "email_sent_successfully": "Email sent successfully",
          "email_sent_success_message": "HTML report has been successfully sent to the specified address.",
          "sent_to": "Sent to",
          "sent_at": "Sent at",
          "great": "Great",
          "email_sent": "Email sent",
          "report_sent_to_email": "Report sent to EMAIL",
          "email_send_failed": "Email sending failed",
          "email_send_failed_message": "We couldn't send the report via email.",
          "error_details": "Error details",
          "unknown_error": "Unknown error",
          "technical_error": "Technical error",
          "connection_error": "Connection error",
          "email_connection_error_message": "Connection error occurred while sending email.",
          ...
          "preview": "Preview",
          "html_report_failed": "HTML report generation failed",
          "html_report_error_message": "Error occurred while generating HTML report. Please try again.",
          "creating_interactive_report": "Creating interactive report...",
          "failed_to_open_html_file": "Failed to open HTML file",
          "failed_to_save_html_file": "Failed to save HTML file: ERROR",
          "options": "Options",
          "report_options": "Report Options",
          "report_generated_successfully_options": "Report generated successfully! Choose what you want to do:",
          "share_report": "Share report",
          "share_with_other_apps": "Share with other apps",
          "send_by_email": "Send by email",
          "send_to_client_email": "Send to client email",
          "copy_file_path": "Copy file path",
          "copy_path_to_clipboard": "Copy path to clipboard",
          "file_path_copied_successfully": "File path copied successfully",
          "share_error": "Sharing error",
          "failed_to_share_file": "Failed to share file",
          "path_copied": "Path copied",
          "loading_preview": "Loading preview...",
          "preparing_report_preview": "Preparing report preview...",
          "preview_failed": "Preview failed",
          "failed_to_load_preview": "Failed to load preview: ERROR",
          "preview_opened": "Preview opened",
          "report_preview_ready": "Report preview ready",
          "failed_to_open_preview": "Failed to open preview",
          "failed_to_display_preview": "Failed to display preview: ERROR",

          'generating_pdf_report': 'Generating PDF Report',
          'creating_professional_pdf': 'Creating Professional PDF Report',
          'pdf_report_generated': 'PDF Report Generated',
          'pdf_report_ready_to_view': 'PDF Report Ready to View',
          'pdf_report_failed': 'PDF Report Failed',
          'pdf_report_error_message': 'Error occurred while generating PDF report. Please try again.',
          'failed_to_open_pdf_file': 'Failed to open PDF file',
          'failed_to_save_pdf_file': 'Failed to save PDF file: {error}',
          'pdf_report_saved_successfully': 'PDF report saved successfully and ready to share',
          'pdf_options': 'Report Options',
          'pdf_generated_successfully_options': 'PDF report generated successfully. Choose an action:',
          'share_pdf': 'Share Report',
          'send_pdf_to_client': 'Send report to client',
          'pdf_path_copied_successfully': 'PDF file path copied successfully',
          'failed_to_share_pdf': 'Failed to share PDF file',
          'confirm_send_pdf_report': 'Do you want to send the PDF report by email?',
          'send_pdf_report': 'Send PDF Report',
          'sending_pdf_report_email': 'Sending PDF Report',
          'pdf_report': 'PDF Report',
          'pdf_report_generation_failed': 'PDF Report Generation Failed',

          'pdf_actions': 'PDF Actions',
          'pdf_saved_successfully_choose_action': 'PDF saved successfully. Choose an action:',
          'pdf_path_copied_for_sharing': 'PDF path copied for sharing',
          'share_failed': 'Share failed',

          'report_send_successfully_message': 'The report has been successfully sent to the specified email address. The client can now access the complete report and print it.',
        },
        'ar': {
          ...
          'creating_professional_pdf': 'إنشاء تقرير PDF احترافي',
          'pdf_report_generated': 'تم إنشاء تقرير PDF',
          'pdf_report_ready_to_view': 'تقرير PDF جاهز للعرض',
          'pdf_report_failed': 'فشل إنشاء تقرير PDF',
          'pdf_report_error_message': 'حدث خطأ أثناء إنشاء تقرير PDF. يرجى المحاولة مرة أخرى.',
          'failed_to_open_pdf_file': 'فشل في فتح ملف PDF',
          'failed_to_save_pdf_file': 'فشل في حفظ ملف PDF: {error}',
          'pdf_report_saved_successfully': 'تم حفظ تقرير PDF بنجاح وجاهز للمشاركة',
          'pdf_options': 'خيارات التقرير',
          'pdf_generated_successfully_options': 'تم إنشاء تقرير PDF بنجاح. اختر الإجراء المطلوب:',
          'share_pdf': 'مشاركة التقرير',
          'send_pdf_to_client': 'إرسال التقرير للعميل',
          'pdf_path_copied_successfully': 'تم نسخ مسار ملف PDF بنجاح',
          'failed_to_share_pdf': 'فشل في مشاركة ملف PDF',
          'confirm_send_pdf_report': 'هل تريد إرسال تقرير PDF بالبريد الإلكتروني؟',
          'send_pdf_report': 'إرسال تقرير PDF',
          'sending_pdf_report_email': 'جاري إرسال تقرير PDF',
          'pdf_report': 'تقرير PDF',
          'pdf_report_generation_failed': 'فشل في إنشاء تقرير PDF',

          'pdf_actions': 'إجراءات PDF',
          'pdf_saved_successfully_choose_action': 'تم حفظ PDF بنجاح. اختر الإجراء المطلوب:',
          'pdf_path_copied_for_sharing': 'تم نسخ مسار PDF للمشاركة',
          'share_failed': 'فشل في المشاركة',
          'report_send_successfully_message': 'تم إرسال التقرير بنجاح إلى البريد الإلكتروني المحدد. يمكن للعميل الآن الوصول إلى التقرير الكامل وطباعته.',
        ...
        'de': {
          ...
          'WINTER_TIRES': 'Winterreifen',
          'HUBCAPS': 'Radkappen',
          'REAR_PARCEL_SHELF': 'Hutablage hinten',
          'NAVIGATION_SYSTEM': 'Navigationssystem',
          'TRUNK_ROLL_COVER': 'Kofferraumabdeckung',
          ...
          'WARNING_TRIANGLE': 'Warndreieck',
          'RADIO': 'Radio',
          'ALLOY_WHEELS': 'Leichtmetallräder',
          'SUMMER_TIRES': 'Sommerreifen',
          'OPERATING_MANUAL': 'Bedienungsanleitung',
          'REGISTRATION_DOCUMENT': 'Zulassungsbescheinigung',
          'COMPRESSOR_REPAIR_KIT': 'Kompressor/Reparaturset',
          'TOOLS_JACK': 'Werkzeuge/Wagenheber',
          'SECOND_SET_OF_TIRES': 'Zweiter Reifensatz',
          'EMERGENCY_WHEEL': 'Notrad',
          'ANTENNA': 'Antenne',
          'FUEL_CARD': 'Tankkarte',
          ...
          "generating_html_report": "HTML-Bericht wird erstellt...",
          "please_wait": "Bitte warten",
          "html_report_generated": "HTML-Bericht erstellt",
          "html_report_saved_successfully": "Bericht erfolgreich gespeichert und bereit zum Teilen",
          "html_report_ready_to_view": "Bericht ist zur Ansicht bereit",
          "report_generation_failed": "Berichterstellung fehlgeschlagen",
          "report_generation_error_message": "Fehler beim Erstellen des Berichts. Bitte versuchen Sie es erneut.",
          "retry": "Erneut versuchen",
          "share": "Teilen",
          "file_path_copied": "Dateipfad kopiert",
          "file_path_copied_to_clipboard": "Dateipfad wurde in die Zwischenablage kopiert",
          "no_email_address": "Keine E-Mail-Adresse",
          "no_client_email_message": "Für diesen Kunden ist keine E-Mail-Adresse registriert",
          "enter_email": "E-Mail eingeben",
          "enter_email_address": "E-Mail-Adresse eingeben",
          "enter_email_to_send_report": "Geben Sie die E-Mail-Adresse ein, um den Bericht zu senden",
          "invalid_email_format": "Ungültiges E-Mail-Format",
          "continue": "Fortsetzen",
          "confirm_send_email": "E-Mail-Versand bestätigen",
          "confirm_send_report_email": "Möchten Sie den HTML-Bericht für diesen Auftrag per E-Mail senden?",

          "email_report_info": "Ein interaktiver HTML-Bericht mit allen Auftragsdetails wird gesendet",
          "sending_email_report": "Bericht wird per E-Mail gesendet...",
          "please_wait_sending": "Bitte warten, wird gesendet...",
          "email_sent_successfully": "E-Mail erfolgreich gesendet",
          "email_sent_success_message": "HTML-Bericht wurde erfolgreich an die angegebene Adresse gesendet.",
          "sent_to": "Gesendet an",
          "sent_at": "Sendezeit",
          "great": "Großartig",
          "email_sent": "E-Mail gesendet",
          "report_sent_to_email": "Bericht wurde an EMAIL gesendet",
          "email_send_failed": "E-Mail-Versand fehlgeschlagen",
          "email_send_failed_message": "Der Bericht konnte nicht per E-Mail gesendet werden.",
          "error_details": "Fehlerdetails",
          "unknown_error": "Unbekannter Fehler",
          "technical_error": "Technischer Fehler",
          "connection_error": "Verbindungsfehler",
          "email_connection_error_message": "Beim Senden der E-Mail ist ein Verbindungsfehler aufgetreten.",
          "troubleshooting_steps": "Fehlerbehebungsschritte",
          "check_internet_connection": "Internetverbindung prüfen",
          "verify_email_address": "E-Mail-Adresse überprüfen",
          ...
          "preview": "Vorschau",
          "html_report_failed": "HTML-Berichterstellung fehlgeschlagen",
          "html_report_error_message": "Fehler beim Erstellen des HTML-Berichts. Bitte versuchen Sie es erneut.",
          "creating_interactive_report": "Interaktiven Bericht erstellen...",
          "failed_to_open_html_file": "HTML-Datei konnte nicht geöffnet werden",
          "failed_to_save_html_file": "Speichern der HTML-Datei fehlgeschlagen: ERROR",
          "options": "Optionen",
          "report_options": "Berichtsoptionen",
          "report_generated_successfully_options": "Bericht erfolgreich erstellt! Wählen Sie aus, was Sie tun möchten:",
          "share_report": "Bericht teilen",
          "share_with_other_apps": "Mit anderen Apps teilen",
          "send_by_email": "Per E-Mail senden",
          "send_to_client_email": "An Kunden-E-Mail senden",
          ...
          "failed_to_share_file": "Datei konnte nicht geteilt werden",
          "path_copied": "Pfad kopiert",
          "loading_preview": "Vorschau wird geladen...",
          "preparing_report_preview": "Berichtsvorschau wird vorbereitet...",
          "preview_failed": "Vorschau fehlgeschlagen",
          "failed_to_load_preview": "Laden der Vorschau fehlgeschlagen: ERROR",
          "preview_opened": "Vorschau geöffnet",
          "report_preview_ready": "Berichtsvorschau bereit",
          "failed_to_open_preview": "Öffnen der Vorschau fehlgeschlagen",
          "failed_to_display_preview": "Anzeigen der Vorschau fehlgeschlagen: ERROR",

          'generating_pdf_report': 'PDF-Bericht wird erstellt',
          'creating_professional_pdf': 'Professionellen PDF-Bericht erstellen',
          'pdf_report_generated': 'PDF-Bericht erstellt',
          'pdf_report_ready_to_view': 'PDF-Bericht zur Ansicht bereit',
          'pdf_report_failed': 'PDF-Bericht fehlgeschlagen',
          'pdf_report_error_message': 'Fehler beim Erstellen des PDF-Berichts. Bitte versuchen Sie es erneut.',
          'failed_to_open_pdf_file': 'PDF-Datei konnte nicht geöffnet werden',
          'failed_to_save_pdf_file': 'PDF-Datei konnte nicht gespeichert werden: {error}',
          'pdf_report_saved_successfully': 'PDF-Bericht erfolgreich gespeichert und bereit zum Teilen',
          'pdf_options': 'Bericht-Optionen',
          'pdf_generated_successfully_options': 'PDF-Bericht erfolgreich erstellt. Wählen Sie eine Aktion:',
          'share_pdf': 'Bericht teilen',
          'send_pdf_to_client': 'Bericht an Kunden senden',
          'pdf_path_copied_successfully': 'PDF-Dateipfad erfolgreich kopiert',
          'failed_to_share_pdf': 'PDF-Datei konnte nicht geteilt werden',
          'confirm_send_pdf_report': 'Möchten Sie den PDF-Bericht per E-Mail senden?',
          'send_pdf_report': 'PDF-Bericht senden',
          'sending_pdf_report_email': 'PDF-Bericht wird gesendet',
          'pdf_report': 'PDF-Bericht',
          'pdf_report_generation_failed': 'PDF-Bericht-Erstellung fehlgeschlagen',


          'pdf_actions': 'PDF-Aktionen',
          'pdf_saved_successfully_choose_action': 'PDF erfolgreich gespeichert. Wählen Sie eine Aktion:',
          'pdf_path_copied_for_sharing': 'PDF-Pfad zum Teilen kopiert',
          'share_failed': 'Teilen fehlgeschlagen',

          'report_send_successfully_message': 'Der Bericht wurde erfolgreich an die angegebene E-Mail-Adresse gesendet. Der Kunde kann nun auf den vollständigen Bericht zugreifen und ihn ausdrucken.',
